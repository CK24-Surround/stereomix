...
public:
	...
	static USMAT_WaitChargeBlocked* WaitChargeBlocked(UGameplayAbility* OwningAbility, ASMPlayerCharacterBase* NewSourceCharacter);
...
protected:
	...
	UFUNCTION() void OnChargeOverlappedCallback(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
