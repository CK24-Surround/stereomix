...
namespace SMTags
{
	...
	namespace GameplayCue
	{
		...
		UE_DEFINE_GAMEPLAY_TAG_COMMENT(ProjectileLaunch_Sound, "GameplayCue.ProjectileLaunch_Sound", "투사체 발사 시 재생되는 게임플레이 큐의 태그입니다. 사운드 전용입니다.");
		UE_DEFINE_GAMEPLAY_TAG_COMMENT(ProjectileHit, "GameplayCue.ProjectileHit", "투사체 적중 시 재생되는 게임플레이 큐의 태그입니다.");
		UE_DEFINE_GAMEPLAY_TAG_COMMENT(ProjectileWallHit, "GameplayCue.ProjectileWallHit", "투사체가 벽에 적중 시 재생되는 게임플레이 큐의 태그입니다.");
		...
		UE_DEFINE_GAMEPLAY_TAG_COMMENT(ImmuneMaterialApply_ElectricGuitar, "GameplayCue.ImmuneMaterialApply_ElectricGuitar", "일렉기타의 면역 머티리얼 적용 시 재생되는 게임플레이 큐의 태그입니다.");
		UE_DEFINE_GAMEPLAY_TAG_COMMENT(ImmuneMaterialReset, "GameplayCue.ImmuneMaterialReset", "면역 머티리얼 리셋 시 재생되는 게임플레이 큐의 태그입니다.");
	}
}
