...
public:
	...
	virtual AActor* GetActorCatchingMe() const = 0;
	...
	virtual bool IsCatchble(AActor* TargetActor) const = 0;
...
public:
	...
	virtual bool OnCaughtReleased(AActor* TargetActor, bool bIsStunTimeOut) = 0;
