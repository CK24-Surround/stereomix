...
const ::uint32_t TableStruct_greet_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::greet::HelloResponse, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ~0u,  // no _weak_field_map_
    ~0u,  // no _inlined_string_donated_
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::greet::HelloResponse, _impl_.message_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        { 0, -1, -1, sizeof(::greet::HelloRequest)},
        { 9, -1, -1, sizeof(::greet::HelloResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::greet::_HelloRequest_default_instance_._instance,
    &::greet::_HelloResponse_default_instance_._instance,
};
const char descriptor_table_protodef_greet_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    " \001(\t2G\n\016GreeterService\0225\n\010SayHello\022\023.gre"
    "et.HelloRequest\032\024.greet.HelloResponseB\025\370"
    "\001\001\252\002\017StereoMix.Greetb\006proto3"
};
...
HelloResponse::HelloResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:greet.HelloResponse)
}
HelloResponse::HelloResponse(const HelloResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:greet.HelloResponse)
}
...
HelloResponse::~HelloResponse() {
  // @@protoc_insertion_point(destructor:greet.HelloResponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:greet.HelloResponse)
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "greet.HelloResponse.message"));
        } else {
          goto handle_unusual;
        }
        continue;
...
::uint8_t* HelloResponse::_InternalSerialize(
    ::uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:greet.HelloResponse)
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_message().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "greet.HelloResponse.message");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:greet.HelloResponse)
  return target;
}

::size_t HelloResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:greet.HelloResponse)
  ::size_t total_size = 0;
...
void HelloResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:greet.HelloResponse)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:greet.HelloResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::greet::HelloResponse*
Arena::CreateMaybeMessage< ::greet::HelloResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::greet::HelloResponse >(arena);
}
