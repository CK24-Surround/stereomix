...
template <>
::greet::HelloResponse* Arena::CreateMaybeMessage<::greet::HelloResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class HelloResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:greet.HelloResponse) */ {
 public:
...
inline const std::string& HelloResponse::message() const {
  // @@protoc_insertion_point(field_get:greet.HelloResponse.message)
...
inline PROTOBUF_ALWAYS_INLINE void HelloResponse::set_message(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:greet.HelloResponse.message)
}
inline std::string* HelloResponse::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:greet.HelloResponse.message)
  return _s;
}
...
inline std::string* HelloResponse::release_message() {
  // @@protoc_insertion_point(field_release:greet.HelloResponse.message)
...
inline void HelloResponse::set_allocated_message(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:greet.HelloResponse.message)
}
